...
def problem2a(circle, rectangle, window):
    ...
    rectangle_line_start = rectangle.get_upper_right_corner()
    rectangle_line_end = rectangle.get_lower_left_corner()
    line = rg.Line(rectangle_line_start, rectangle_line_end)
    line.arrow = 'last'
