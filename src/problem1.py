...
def run_test_problem1a():
    ...
    # Test 2:
    expected = 0.402  # This is APPROXIMATELY the correct answer.
    answer = problem1a(23, 56)
    print()
    ...
    # Test 3:
    expected = 0.080  # This is APPROXIMATELY the correct answer.
    answer = problem1a(43, 49)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = -0.160  # This is APPROXIMATELY the correct answer.
    answer = problem1a(13, 39)
    print()
...
def run_test_problem1b():
    ...
    # Test 4:
    expected = 24  # This is APPROXIMATELY the correct answer.
    answer = problem1b(7, 15)
    print()
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
